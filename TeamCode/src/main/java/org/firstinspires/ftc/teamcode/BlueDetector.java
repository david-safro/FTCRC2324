...
public class BlueDetector extends OpMode {
    ...
    public void init() {
        ...
        double minArea = 25000; // the minimum area for the detection to consider for your prop

        colourMassDetectionProcessor = new ColourMassDetectionProcessor(
                lower,
                upper,
                () -> minArea, // these are lambda methods, in case we want to change them while the match is running, for us to tune them or something
                () -> 500, // the left dividing line, in this case the left third of the frame
                () -> 1000 // the left dividing line, in this case the right third of the frame
        );
